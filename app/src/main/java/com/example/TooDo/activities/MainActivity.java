package com.example.TooDo.activities;
...
import com.example.TooDo.adapters.PendingTodoAdapter;
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                for(PendingTodoModel pendingTodoModel:pendingTodoModels){
                    ...
                    String getTodoPriority=pendingTodoModel.getTodoPriority().toLowerCase();
                    String getTodoProgress=pendingTodoModel.getTodoProgress().toLowerCase();
            ...
            public void onClick(View view) {
                ...
                if(isTitleEmpty){
                    ...
                    todoTime.setError("Todo time required !");
                        ...
                        new PendingTodoModel(getTodoTitle,getTodoContent,String.valueOf(todoTagID),getTodoDate,getTime,getTodoPriority,getTodoProgress)
                )){
