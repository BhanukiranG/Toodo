...
public class TodoDBHelper {
    ...
    public boolean addNewTodo(PendingTodoModel pendingTodoModel){
        ...
        contentValues.put(DatabaseHelper.COL_TODO_PRIORITY,pendingTodoModel.getTodoPriority());
        contentValues.put(DatabaseHelper.COL_TODO_PROGRESS,pendingTodoModel.getTodoProgress());
    ...
    public ArrayList<PendingTodoModel> fetchAllTodos(){
        ...
        while (cursor.moveToNext()){
            ...
            pendingTodoModel.setTodoPriority(cursor.getString(cursor.getColumnIndex(DatabaseHelper.COL_TODO_PRIORITY)));
            pendingTodoModel.setTodoProgress(cursor.getString(cursor.getColumnIndex(DatabaseHelper.COL_TODO_PROGRESS)));
    ...
    public ArrayList<CompletedTodoModel> fetchCompletedTodos(){
        ...
        while (cursor.moveToNext()){
            ...
            completedTodoModel.setTodoContent(cursor.getString(cursor.getColumnIndex(DatabaseHelper.COL_TODO_PRIORITY)));
    ...
    //fetch todos content from the database according the todos id
    public String fetchTodoPriority(int todoID){
        SQLiteDatabase sqLiteDatabase=this.databaseHelper.getReadableDatabase();
        String query="SELECT " + DatabaseHelper.COL_TODO_PRIORITY + " FROM " + DatabaseHelper.TABLE_TODO_NAME + " WHERE " + DatabaseHelper.COL_TODO_ID+"=?";
        Cursor cursor=sqLiteDatabase.rawQuery(query,new String[]{String.valueOf(todoID)});
        String content="";
        if(cursor.moveToFirst()){
            content=cursor.getString(cursor.getColumnIndex(DatabaseHelper.COL_TODO_PRIORITY));
        }
        cursor.close();
        sqLiteDatabase.close();
        return content;
    ...
    //fetch todos content from the database according the todos id
    public String fetchTodoProgress(int todoID){
        SQLiteDatabase sqLiteDatabase=this.databaseHelper.getReadableDatabase();
        String query="SELECT " + DatabaseHelper.COL_TODO_PROGRESS + " FROM " + DatabaseHelper.TABLE_TODO_NAME + " WHERE " + DatabaseHelper.COL_TODO_ID+"=?";
        Cursor cursor=sqLiteDatabase.rawQuery(query,new String[]{String.valueOf(todoID)});
        String content="";
        if(cursor.moveToFirst()){
            content=cursor.getString(cursor.getColumnIndex(DatabaseHelper.COL_TODO_PROGRESS));
        }
        cursor.close();
        sqLiteDatabase.close();
        return content;
