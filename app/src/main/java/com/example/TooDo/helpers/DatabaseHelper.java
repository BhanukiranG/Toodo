...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_TODO_PRIORITY="todo_priority";
    public static final String COL_TODO_PROGRESS="todo_progress";
    ...
    private static final String CREATE_TODOS_TABLE="CREATE TABLE IF NOT EXISTS " + TABLE_TODO_NAME+"("+
            ...
            COL_TODO_TITLE+" TEXT NOT NULL,"+COL_TODO_CONTENT+" TEXT NOT NULL,"+COL_TODO_PRIORITY+" TEXT NOT NULL,"+COL_TODO_PROGRESS+" TEXT NOT NULL,"+
